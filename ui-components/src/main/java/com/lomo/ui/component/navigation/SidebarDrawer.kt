...
data class SidebarStats(val memoCount: Int = 0, val tagCount: Int = 0, val dayCount: Int = 0)

data class SidebarTag(val name: String, val count: Int = 0)
                ...
                verticalArrangement = Arrangement.spacedBy(8.dp)
                        ...
                        item {
                                Row(
                                        ...
                                        ) { Icon(Icons.Rounded.Settings, androidx.compose.ui.res.stringResource(com.lomo.ui.R.string.sidebar_settings)) }
                                }
                        ...
                        item {
                                Row(
                                        ...
                                        StatItem(value = stats.memoCount.toString(), label = androidx.compose.ui.res.stringResource(com.lomo.ui.R.string.stat_memo))
                                        StatItem(value = stats.tagCount.toString(), label = androidx.compose.ui.res.stringResource(com.lomo.ui.R.string.stat_tag))
                                        StatItem(value = stats.dayCount.toString(), label = androidx.compose.ui.res.stringResource(com.lomo.ui.R.string.stat_day))
                                }
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                if (hasChildren) {
                    ...
                    Icon(
                        ...
                        contentDescription = androidx.compose.ui.res.stringResource(if (isExpanded) com.lomo.ui.R.string.cd_collapse else com.lomo.ui.R.string.cd_expand),
                        modifier = Modifier
                            .size(20.dp)
                            .clickable { 
                                haptic.light()
...
private class MutableTagNode(
    ...
    fun toImmutable(): TagNode {
        return TagNode(name, fullPath, count, children.map { it.toImmutable() })
    }
}
